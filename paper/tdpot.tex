...
For CCH, the construction of the augmented graph is split in three steps.
...
In the second step the topology of the augmented graph is computed.
...
In the final step, the \emph{customization}, the weights of the augmented graph are computed.
